#ifndef CircularDynamicArrayList_H
#define CircularDynamicArrayList_H
...
template <class T>
class CircularDynamicArrayList
{
private:
    T *array;
    int first_index = 0;
...
public:
    ...
    template <class Type>
    static CircularDynamicArrayList<Type> *build(Type *items, int capacity)
    {
